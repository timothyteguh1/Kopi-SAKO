  ...
  Future<void> _handleRegister() async {
    ...
    if (mounted) {
      ...
      if (errorMsg != null) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Akun berhasil dibuat! Silakan masuk.'), backgroundColor: AppColors.primaryOrange));
        context.pop();
      }
    }
  }
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 20),
                        SakoTextField(controller: _emailController, label: 'Email (Untuk Pemulihan)', hint: 'nama@email.com', prefixIcon: Icons.mail_outline, keyboardType: TextInputType.emailAddress),
                        const SizedBox(height: 20),
