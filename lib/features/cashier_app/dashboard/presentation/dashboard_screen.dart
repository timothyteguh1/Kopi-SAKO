...
class _DashboardScreenState extends ConsumerState<DashboardScreen> {
  ...
  void _showSettingsModal(BuildContext context) async {
    ...
    try {
      ...
      final rateCtrl = TextEditingController(
        text: data['points_conversion_rate'].toString(),
      );
      ...
      showDialog(
        ...
        builder: (ctx) => AlertDialog(
          ...
          content: Column(
            ...
            children: [
              const Text(
                '1 Poin didapatkan setiap pembelian kelipatan:',
                        ...
                        return ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return ListTile(
                              ...
                              onTap: () {
                                ref
                                        .read(activeBranchIdProvider.notifier)
                                        .state =
                                    branch['id'];
                                ref
                                        .read(activeBranchNameProvider.notifier)
                                        .state =
                                    branch['name'];
  ...
  void _showLogoutConfirmation(BuildContext context) {
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: const Text(
          'Apakah Anda yakin ingin logout dari sistem kasir ini?',
        ),
        actions: [
          TextButton(
            onPressed: () => Navigator.pop(ctx),
  ...
  Widget build(BuildContext context) {
    final initBranchAsync = ref.watch(branchInitializationProvider);
    ...
    return Scaffold(
      ...
      body: initBranchAsync.isLoading
          ...
          : initBranchAsync.hasError
          ? Center(
              child: Text(
                'Terjadi kesalahan sistem: ${initBranchAsync.error}',
                                ...
                                child: Padding(
                                  ...
                                  child: Row(
                                    children: [
                                      _buildDetailCard(
                                        'Tunai',
                                        formatRupiah(sales.cash),
                                        Icons.payments,
                                      ),
                                      const SizedBox(width: 12),
                                      _buildDetailCard(
                                        'QRIS/Transfer',
                                        formatRupiah(sales.nonCash),
                    ...
                    if (orders.isEmpty)
                      return SliverToBoxAdapter(
                        child: Padding(
                          ...
                          child: Center(
                            child: Text(
                              'Belum ada antrean pesanan di cabang ini.',
...
class _LiveOrderCardState extends State<LiveOrderCard> {
  ...
  Widget build(BuildContext context) {
    final String orderId =
        '#${widget.order['id'].toString().substring(0, 6).toUpperCase()}';
    final String customerName =
        widget.order['customer_name_snapshot'] ?? 'Pelanggan';
    final String amount = NumberFormat.currency(
      locale: 'id',
      symbol: 'Rp ',
      decimalDigits: 0,
    ).format(widget.order['total_amount'] as int);
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: isCompleted ? Colors.grey.shade50 : AppColors.surfaceWhite,
          borderRadius: BorderRadius.circular(20),
          border: Border.all(color: Colors.grey.shade200),
        ),
        child: Column(
                  ...
                  children: [
                        ...
                        child: Row(
                          children: [
                            Icon(
                              ...
                              size: 14,
                              color: _isOverdue ? Colors.green : Colors.blue,
                            ),
                    ...
                    Container(
                      ...
                      child: Text(
                        isCompleted
                            ? 'Selesai'
                            : (isProcessing ? 'Diproses' : 'Menunggu'),
                        style: TextStyle(
                          color: isCompleted
                              ? Colors.grey.shade600
                              : (isProcessing ? Colors.blue : Colors.orange),
                          fontSize: 12,
                          fontWeight: FontWeight.bold,
                        ),
                      ),
